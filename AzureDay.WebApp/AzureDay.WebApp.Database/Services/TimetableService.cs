    ...
    public class TimetableService : BaseService<TimetableEntity, int>
    {
        ...
        protected override List<TimetableEntity> PopulateStorage()
        {
            ...
            _timetables.AddRange(new List<TimetableEntity> // webdev
			{
                ...
                new TimetableEntity { TimeStart = "16:00", TimeEnd = "17:00", Room = _roomService.Room1, Topic = _topicService.ILubenets_01 },
                new TimetableEntity { TimeStart = "17:30", TimeEnd = "18:30", Room = _roomService.Room1, Topic = _topicService.SKalinets_01 },
            ...
            _timetables.AddRange(new List<TimetableEntity> // iot
			{
                ...
                new TimetableEntity { TimeStart = "16:00", TimeEnd = "17:00", Room = _roomService.Room2, Topic = _topicService.NDranchuk_01 },
            ...
            _timetables.AddRange(new List<TimetableEntity> // AInML
			{
                ...
                new TimetableEntity { TimeStart = "14:45", TimeEnd = "15:45", Room = _roomService.Room3, Topic = _topicService.SPoplavskiy_02 },
                new TimetableEntity { TimeStart = "16:00", TimeEnd = "17:00", Room = _roomService.Room3, Topic = _topicService.OKrakovetskyi_02 },
                new TimetableEntity { TimeStart = "17:30", TimeEnd = "18:30", Room = _roomService.Room3, Topic = _topicService.KBaczyk_01 }
            });
