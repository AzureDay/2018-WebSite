    ...
    public class TimetableService : BaseService<TimetableEntity, int>
    {
        ...
        protected override List<TimetableEntity> PopulateStorage()
        {
            ...
            _timetables.AddRange(new List<TimetableEntity> // orange
			{
                ...
                new TimetableEntity { TimeStart = "12:00", TimeEnd = "13:00", Room = _roomService.Room1, Topic = _topicService.SSultanov_01 },
            ...
            _timetables.AddRange(new List<TimetableEntity> // red
			{
                ...
                new TimetableEntity { TimeStart = "16:00", TimeEnd = "17:00", Room = _roomService.Room3, Topic = _topicService.SPoplavskiy_01 },
                new TimetableEntity { TimeStart = "17:30", TimeEnd = "18:30", Room = _roomService.Room3, Topic = _topicService.ILubenets_01 }
            });
